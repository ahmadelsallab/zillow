...
for c in prop_in.columns:
    prop_in[c]=prop_in[c].fillna(-1)
    if prop_in[c].dtype == 'object':
        lbl = LabelEncoder()
        lbl.fit(list(prop_in[c].values))
        prop_in[c] = lbl.transform(list(prop_in[c].values))

# Fill in main features DF
prop= pd.DataFrame()
prop['parcelid'] = prop_in['parcelid']
#living area proportions 
prop['living_area_prop'] = prop_in['calculatedfinishedsquarefeet'] / prop_in['lotsizesquarefeet']
#tax value ratio
prop['value_ratio'] = prop_in['taxvaluedollarcnt'] / prop_in['taxamount']
#tax value proportions
prop['value_prop'] = prop_in['structuretaxvaluedollarcnt'] / prop_in['landtaxvaluedollarcnt']
# locations prop
prop['latitude'] = prop_in['latitude']
prop['longitude'] = prop_in['longitude']
prop['regionidcounty'] = prop_in['regionidcounty']
prop['regionidcity'] = prop_in['regionidcity']
prop['regionidneighborhood'] = prop_in['regionidneighborhood']
...
pd.to_pickle((x_train, x_test, y_train), "tmp.pickle")
